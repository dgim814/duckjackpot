...
export function HomePage() {
  ...
  return (
    <div className="px-4 pb-4">
      ...
      <section className="mt-3 rounded-2xl border border-amber-400/40 bg-[#1a1410] px-3 py-3">
        <div className="flex items-end justify-between gap-3">
          <div>
            <p className="text-[11px] font-extrabold uppercase tracking-[0.18em] text-amber-200">
              {t('limitedDrop')}
            </p>
            <p className="mt-1 text-sm font-extrabold leading-snug text-amber-50">
              {t('soldProgress', {
          ...
          <span className="text-sm font-extrabold tabular-nums text-amber-200">{Math.round(progress)}%</span>
        </div>
