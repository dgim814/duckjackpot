import { Crosshair, History, Home, Layers, ScrollText, User } from 'lucide-react'
...
const tabs: { to: string; labelKey: MessageKey; icon: typeof Home; end: boolean }[] = [
  ...
  { to: '/hunt', labelKey: 'navHunt', icon: Crosshair, end: false },
...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-white/8 bg-[#0d0b10]/95 backdrop-blur-xl">
      <ul className="mx-auto grid max-w-lg grid-cols-6 px-0.5 pb-[max(8px,env(safe-area-inset-bottom))] pt-2">
